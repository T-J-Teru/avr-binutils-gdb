...
extern struct avr_property_header *avr_elf32_load_property_records (bfd *abfd);

/* Return a string that is the name of the property record pointed to by REC.  */
extern const char *avr_elf32_property_record_name_string (struct avr_property_record *rec);
